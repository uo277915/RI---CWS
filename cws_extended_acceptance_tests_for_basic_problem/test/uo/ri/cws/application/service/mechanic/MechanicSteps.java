...
public class MechanicSteps {
	...
	private MechanicCrudService service = Factory.service.forMechanicService();
	...
	@When("I try to add a new non existing mechanic")
	...
	@When("I update a mechanic with null dni")
	public void iUpdateAMechanicWithNullDni() throws BusinessException {
	...
	public void theMechanicResultsAddedToTheSystem() throws BusinessException {
		MechanicCrudService service = Factory.service.forMechanicService();
